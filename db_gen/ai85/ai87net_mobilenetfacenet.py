...
class AI87MobileNetV2(nn.Module):
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        self.maxpool = ai8x.MaxPool2d(kernel_size=2, stride=2)
        self.dwise = ai8x.FusedDepthwiseConv2dReLU(64, 64, 3,
                                                             padding=1, stride=1,
    ...
    def forward(self, x):  # pylint: disable=arguments-differ
        ...
        #x = x.mul(256.).round().clamp(min=-128, max=127) #ai8xize the outputs
        return x

def ai87netmobilefacenet(pretrained=False, **kwargs):
    ...
    return AI87MobileNetV2(pre_layer_stride=1, bottleneck_settings=bottleneck_settings,
                           last_layer_width=128, avg_pool_size=(10,7),  depthwise_bias=False, wide=False, **kwargs) #Dwsize bias is false due to bias memory constraints
models = [
    {
        'name': 'ai87netmobilefacenet',
        'min_input': 1,
        'dim': 3,
    },
]
